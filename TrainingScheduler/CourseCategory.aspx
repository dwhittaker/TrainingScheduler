   					...
   					<ContentTemplate>	
   						<asp:panel id = "PanAddEdit" runat="Server" visible = "false">
   							<table>
   								<tr>
   									<td>Category name</td>
   									<td><asp:textbox id="txtCatName" runat="Server"/>
   								</tr>
   								<tr>
   								...
   								<tr>
   									...
   									<td><asp:dropdownlist id="ddlReport" runat="Server"/>
   								</tr>
   								<tr>
   									<td>
   										<table>
   											<tr>
   												<td align = "center"><asp:button id="btnSaveEdit" Text = "Save Category" runat="server" autopostback = "True"/></td>
